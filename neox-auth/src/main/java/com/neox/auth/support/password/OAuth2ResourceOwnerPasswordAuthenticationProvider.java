package com.neox.auth.support.password;

import java.util.Map;

import com.neox.auth.support.base.OAuth2ResourceOwnerBaseAuthenticationProvider;
...
public class OAuth2ResourceOwnerPasswordAuthenticationProvider
	...
	public void checkClient(RegisteredClient registeredClient) {
		...
		if (!registeredClient.getAuthorizationGrantTypes().contains(new AuthorizationGrantType(
